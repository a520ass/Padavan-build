...
# ./create-ubifs.sh 2048 64 21078016 1024 ./jffs2
...
echo "vol_name=file_system" >>$config_file
...
echo "mkfs.ubifs -x lzo -m $page_size_in_bytes -e $logical_erase_block_size -c $patition_logical_blocks -o rootfs_ubifs.img -d $path_to_rootfs"
check_result
...
echo "ubinize -o ubi.img -m $page_size_in_bytes -p $block_size -s $page_size_in_bytes $config_file -v"
check_result
